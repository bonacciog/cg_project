...
/*   mo_matrix1 = m4.copy(mo_matrix);
  ...
  //  drawCube();
  drawObjectFill(objects, 'posteriore_destra', 0, 1, 0);
  drawObjectWire(objects, 'posteriore_destra'); */
 ...
 // mo_matrix1 = m4.translate(mo_matrix1, -0.58, +raggio - 0.28, +0.8);
  ...
  gl.uniformMatrix4fv(_Mmatrix, false, mo_matrix1);
  //  drawCube();
  drawObjectFill(objects, 'posteriore_sinistra', 0, 0, 0);
  drawObjectWire(objects, 'posteriore_sinistra');
  ...
  gl.uniformMatrix4fv(_Mmatrix, false, mo_matrix1);
  //  drawCube();
  drawObjectFill(objects, 'anteriore_destra', 0, 0, 0);
  drawObjectWire(objects, 'anteriore_destra');*/
  ...
  gl.uniformMatrix4fv(_Mmatrix, false, mo_matrix1);
  //  drawCube();
  drawObjectFill(objects, 'anteriore_sinistra', 0, 1, 0);
  drawObjectWire(objects, 'anteriore_sinistra');  
}
